// A more complex server that reads / writes file in response to
// to GET and POST.  Morgan mudule used to console log all requests.
// Usage:
// -- http GET localhost:8000/guests
// -- http POST localhost:8000/guests name=NewPerson
// -- http GET localhost:8000/guests
